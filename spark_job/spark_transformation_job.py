...
def main(env, bq_project, bq_dataset, transformed_table, route_insights_table, origin_insights_table):
    try:
        ...
        input_path = f"gs://airflow-projects-self/flights_booking_data_cicd/source-{env}"
        ...
        transformed_data = data.withColumn(
            ...
            .when((col("purchase_lead") < 30), lit("Short-Term"))
        ...
        logger.error("An error occurred during the Spark job execution.", exc_info=True)
        sys.exit(1)
